...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
       ...
       self.cancelButtonNormalColor = [UIColor colorWithRed:59.0/255 green:72/255.0 blue:5.0/255 alpha:1];
		//self.cancelButtonNormalColor = [UIColor greenColor];
       ...
       // self.cancelButtonBackgroundColor = [UIColor colorWithRed:236.0/255 green:240/255.0 blue:241.0/255 alpha:1];
        self.cancelButtonBackgroundColor  = [UIColor greenColor];
		
        self.confirmButtonNormalColor = [UIColor colorWithRed:59.0/255 green:72/255.0 blue:5.0/255 alpha:1];
      ...
      self.confirmButtonBackgroundColor  = [UIColor greenColor];
...
- (UIView *)buildBackgroundDimmingView{
   ...
   */
	/*只有图片那么大*/
	UIView *bgView;
	CGRect cgrect = self.containerView.frame;
	CGPoint cgCenter = self.containerView.center;
	if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_7_1) {
		UIBlurEffect *eff = [UIBlurEffect effectWithStyle:UIBlurEffectStyleDark];
		bgView = [[UIVisualEffectView alloc] initWithEffect:eff];
		bgView.frame = CGRectMake(cgCenter.x, cgCenter.y, cgrect.size.width, cgrect.size.height);
		}
		else {
			bgView = [[UIView alloc] initWithFrame:self.frame];
			bgView.backgroundColor = [UIColor blackColor];
